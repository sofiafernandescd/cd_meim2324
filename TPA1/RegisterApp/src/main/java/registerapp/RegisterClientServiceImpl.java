...
import ContractClientRegister.ClentRequest;
import ContractClientRegister.ServerResponse;
import ContractClientRegister.ClentRegisterServiceGrpc;


import java.util.LinkedList;

public class RegisterClientServiceImpl extends ClientRegisterServiceGrpc.ClientRegisterServiceImplBase {

    private final RingInfo ringInfo;

    public RegisterClientServiceImpl(RingInfo ringInfo) {
